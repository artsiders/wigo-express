      ...
      <div className="flex flex-col md:flex-row gap-6 relative z-10">
        ...
        <div className="flex-1 flex gap-6">
          ...
          <div className="flex flex-col items-center justify-between py-1 relative w-6">
            <span className="text-sm font-black text-dark">{ride.departure.time}</span>
            ...
            <span className="text-sm font-black text-dark">{ride.arrival.time}</span>
          </div>

          {/* Locations UI */}
          <div className="flex flex-col justify-between py-1">
            <div className="mb-8">
              <h3 className="text-lg font-bold text-dark leading-none">{ride.departure.city}</h3>
              <p className="text-sm text-neutral-500 font-medium">{ride.departure.place}</p>
            </div>
            <div>
              <h3 className="text-lg font-bold text-dark leading-none">{ride.arrival.city}</h3>
              <p className="text-sm text-neutral-500 font-medium">{ride.arrival.place}</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex md:flex-col justify-between items-center md:items-end gap-4 min-w-[200px]">
          ...
          <div className="text-right flex-1 md:flex-none">
            ...
            <p className="text-xs font-bold text-neutral-400 mt-1 uppercase tracking-wider flex justify-end gap-2 items-center">
          ...
          <div className="flex items-center gap-3 bg-light-400 px-3 py-2 rounded-2xl md:ml-auto">
             ...
             <div className="text-left">
               <h4 className="text-sm font-bold text-dark">{ride.driver.name}</h4>
