...
export default function OfferWizardLayout({
  ...
  return (
    <div className="w-full h-full bg-white rounded-xl lg:rounded-2xl shadow-[0_20px_60px_rgba(0,0,0,0.05)] border border-neutral-100 flex flex-col relative min-h-[600px]">
      {/* Header & Progression */}
