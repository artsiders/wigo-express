      ...
      <div className="w-full max-w-6xl bg-white rounded-[3rem] shadow-[0_30px_60px_rgba(0,0,0,0.06)] flex flex-col lg:flex-row overflow-hidden min-h-[750px]">
        ...
        <div ref={imageRef} className="hidden lg:flex flex-col relative w-1/2 bg-dark">
          ...
          <div className="relative z-10 p-14 h-full flex flex-col">
            <Link href="/" className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center backdrop-blur-md text-white hover:bg-white/40 transition-colors">
            ...
            <div className="mt-auto">
              ...
              <p className="text-white/80 font-medium text-lg max-w-md">
                Accédez à votre espace Wigo Express et gérez vos trajets en toute simplicité et haute sécurité.
              </p>
            </div>
          </div>
        </div>
        ...
        <div ref={formRef} className="w-full lg:w-1/2 p-8 sm:p-14 flex flex-col justify-center relative">
          ...
          <div className="max-w-md w-full mx-auto">
            <h2 className="text-3xl lg:text-4xl font-black text-dark mb-2">Bienvenue</h2>
            <p className="text-neutral-500 font-medium mb-10">Connectez-vous pour continuer sur Wigo Express.</p>
            ...
            <div className="flex items-center gap-4 my-8">
              ...
              <span className="text-xs font-bold text-neutral-400 uppercase tracking-widest">ou avec votre e-mail</span>
              <div className="flex-1 h-px bg-neutral-100"></div>
            </div>
            ...
            <form onSubmit={handleCredentialsLogin} className="flex flex-col gap-5">
              ...
              <div className="flex justify-end text-sm">
                <Link href="#" className="font-bold text-primary hover:text-dark transition-colors">Mot de passe oublié ?</Link>
              </div>
            ...
            <p className="text-center font-medium text-neutral-500 mt-10">
              Nouveau sur Wigo ? <Link href="/register" className="font-bold text-primary hover:text-dark transition-colors">Créer un compte</Link>
            </p>
          </div>
        </div>
      </div>
