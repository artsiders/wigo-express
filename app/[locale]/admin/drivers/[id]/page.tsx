  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        {isLoading ? (
          <div className="h-6 w-48 bg-neutral-100 rounded-md animate-pulse" />
        ) : (
          <h2 className="text-xl font-black text-dark-900 uppercase tracking-tight">Validation Conducteur</h2>
        )}
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-xl border border-neutral-200 shadow-sm">
            {isLoading ? (
              ...
              <>
                <h3 className="text-sm font-black text-dark-900 uppercase tracking-widest mb-6 font-sans">Utilisateur</h3>
                ...
                <div className="space-y-4 py-6 border-y border-neutral-50 mb-8">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="flex items-center gap-2 text-dark-800 text-sm font-bold">
                      ...
                      {request?.expiryDate && new Date(request.expiryDate).toLocaleDateString('fr-FR', { day: 'numeric', month: 'long', year: 'numeric' })}
                    </div>
                  </div>
                </div>
