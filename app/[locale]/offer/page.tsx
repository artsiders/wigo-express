...
export default function OfferRidePage() {
  ...
  const stepContents = {
    1: {
      ...
      subtitle: "Où allez-vous ? Définissez le point de départ et d'arrivée de votre aventure communautaire.",
      image: "https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?q=80&w=1000&auto=format&fit=crop" // Road trip map feel
    },
    2: {
      title: "Vos conditions",
      subtitle: "Fixez un prix juste et indiquez le nombre de places disponibles pour voyager en tout confort.",
    ...
    3: {
      ...
      subtitle: "Revoyez les détails une dernière fois avant de publier votre trajet aux milliers d'utilisateurs.",
      image: "https://images.unsplash.com/photo-1519003722824-194d4455a60c?q=80&w=1000&auto=format&fit=crop" // Scenic beautiful road
    }
  };
  ...
  return (
    <main className="container mx-auto px-4 md:px-8 lg:px-12 flex flex-col items-center">
      <div className="w-full max-w-7xl flex flex-col lg:flex-row gap-8 lg:gap-16 items-stretch">
        
        {/* Creative Left Column - Dynamic based on step */}
        <div ref={leftColRef} className="w-full lg:w-5/12 hidden lg:flex flex-col relative rounded-[3rem] overflow-hidden shadow-2xl border border-white border-opacity-50">
          <Image 
