...
export default function ProfileEditPage() {
  ...
  return (
    <div className="flex flex-col gap-8 pb-12">
      ...
      >
        <div className="bg-white rounded-3xl p-8 md:p-10 shadow-[0_20px_40px_rgba(0,0,0,0.03)] border border-neutral-100 space-y-8">
          ...
          <div className="space-y-2">
            ...
            <div className="relative bg-light-400 rounded-xl border border-neutral-300 focus-within:bg-white focus-within:border-primary-500/40 focus-within:ring-4 focus-within:ring-primary-500/10 transition-all p-4 group">
              ...
              <textarea
                className="w-full bg-transparent text-dark outline-none placeholder:text-neutral-500 min-h-[120px] pl-10 pr-2 py-1 resize-none font-medium"
